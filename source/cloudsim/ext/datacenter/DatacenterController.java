...
public class DatacenterController extends DatacenterBroker implements GeoLocatable,
	...
	public DatacenterController(String name, 
		...
		} else if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_PSOV)){
			this.loadBalancer = new PSOV(this);
		} else if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_ANT)){
				this.loadBalancer = new AntColony(this);
